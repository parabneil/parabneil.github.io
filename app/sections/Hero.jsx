...
const Hero = () => {
  ...
  return (
    <section
      id="hero"
      className="relative flex items-center justify-center min-h-screen overflow-hidden dark:bg-black"
    >
      {/* Background Image */}
      {/* <Image 
      ...
      {/* CONTENT */}
      <div className="absolute bottom-5 left-0 right-0 z-30 flex flex-col items-center px-6">
        <motion.h2
        ...
        <motion.p className="mt-4 text-center max-w-xl text-gray-600 dark:text-gray-300 leading-tight">
          {headline}
        </motion.p>
